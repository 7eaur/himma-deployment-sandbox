...
{"n":8,"skill":"مفاهيم المادة المطبوعة — تمييز الحرف","q":"انظر إلى العناصر، ثم اضغط على الحرف فقط.","kind":"none","instruction":"اختر العنصر الذي يمثل حرفًا واحدًا، وليس كلمة أو جملة كاملة.","enc":"رائع، اختر بهدوء!"},
