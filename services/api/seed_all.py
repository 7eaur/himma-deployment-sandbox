...
maintenance extensions and the latest student-facing presentation overlays.
"""
...
import seed_learning_posttest_experience_2026_09_01
...
def run_seed_all() -> dict[str, int]:
    ...
    projection_result = seed_learning_posttest_experience_2026_09_01.run_seed()
    ...
    result = {
        ...
        "learning_experience_changes": projection_result["learning_changed"],
        "learning_experience_items": learning_marked,
        "posttest_experience_changes": projection_result["posttest_changed"],
